...
public class DiamondSwordBWI implements BedwarsItem {

    public static ItemStack item = new ItemStack(Material.DIAMOND_SWORD, 1);
    public static String displayName = "Diamond Sword";
    public static Category category = Category.Melee;
    public static String description = "";
    public static Currency cost = new Currency(0, 0, 0, 3);
    ...
    public DiamondSwordBWI clone() {
	return new DiamondSwordBWI();
    }
}
