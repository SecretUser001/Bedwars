...
public class AxeBWI implements UpgradebleBedwarsItem {
    ...
    public List<PermanentBedwarsItem> upgrades = new ArrayList<PermanentBedwarsItem>(Arrays
	    .asList(new WoodenAxeBWI(this), new StoneAxeBWI(this), new IronAxeBWI(this), new DiamondAxeBWI(this)));
